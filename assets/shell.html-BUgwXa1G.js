import{_ as n,e as a,f as e,o as l}from"./app-Cvir-LXC.js";const i={};function p(c,s){return l(),a("div",null,s[0]||(s[0]=[e(`<h2 id="linxu-shell" tabindex="-1"><a class="header-anchor" href="#linxu-shell"><span>Linxu Shell</span></a></h2><h3 id="shell脚本编写" tabindex="-1"><a class="header-anchor" href="#shell脚本编写"><span>shell脚本编写</span></a></h3><ul><li>vim helloworld.sh</li></ul><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code><span class="line"><span class="token shebang important">#! /bin/bash</span></span>
