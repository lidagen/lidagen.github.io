import{_ as n,e as a,f as e,o as p}from"./app-Cvir-LXC.js";const l={};function t(i,s){return p(),a("div",null,s[0]||(s[0]=[e(`<h2 id="vuepress-搭建自己的博客" tabindex="-1"><a class="header-anchor" href="#vuepress-搭建自己的博客"><span>vuepress 搭建自己的博客</span></a></h2><ul><li>VuePress 是什么： VuePress是以Vue驱动的静态网站生成器，是一个由Vue、Vue Router和webpack驱动的单页应用。在VuePress中，你可以使用Markdown编写文档，然后生成网页，每一个由VuePress生成的页面都带有预渲染好的HTML，也因此具有非常好的加载性能和搜索引擎优化。同时，一旦页面被加载，Vue将接管这些静态内容，并将其转换成一个完整的单页应用，其他的页面则会只在用户浏览到的时候才按需加载。</li></ul><h4 id="环境搭建" tabindex="-1"><a class="header-anchor" href="#环境搭建"><span>环境搭建</span></a></h4><ul><li>VuePress支持使用Yarn和npm来安装，Node.js版本需要&gt;=8才可以。</li></ul><h4 id="全局安装vuepress" tabindex="-1"><a class="header-anchor" href="#全局安装vuepress"><span>全局安装VuePress</span></a></h4><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">yarn global add vuepress # 或者：npm install -g vuepress</span>
